<?php 
    ...
    if(isset($_POST['android_verify_btn'])){
        ...
        if($_POST['envato_buyer_name']!='' AND $envato_buyer->buyer==$_POST['envato_buyer_name'] AND ($envato_buyer->item->id=='7506537' OR $envato_buyer->item->id=='20239372'))
        {
        ...
        if($_POST['envato_buyer_name']!='' AND $envato_buyer->buyer==$_POST['envato_buyer_name'] AND ($envato_buyer->item->id=='16698131' OR $envato_buyer->item->id=='20239372'))
        {
